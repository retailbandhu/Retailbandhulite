...
export function FAQPage({ onBackToHome, onNavigateToVideos }: FAQPageProps) {
  ...
  const navLinks = [
    ...
    { id: 'compare', label: 'Compare', icon: GitCompare, onClick: () => toast.info('📊 Feature comparison coming soon!') },
    { id: 'success', label: 'Success Stories', icon: Trophy, onClick: () => toast.info('🏆 Customer success stories coming soon!') },
    { id: 'roi', label: 'ROI Calculator', icon: Calculator, onClick: () => toast.info('🧮 ROI calculator coming soon!') },
